...
async def callbackQueries(client, query):
    ...
    if chat_id in bot_admins:
        ...
        # New group report submenu with each button on one line
...
• زمان سپری شده : {spendTime}''')
    ...
    # --- Group Report (other) with predefined texts ---
...
• زمان سپری شده : {spendTime}''')
    ...
    # For REPORT (scam) with predefined texts
